        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
					...
					<li class="page-scroll">
                        <a href="page/sectores.html">Sectores</a>
                    </li>
					 <li class="page-scroll">
                        <a href="page/pesoIdeal.html">Peso Ideal</a>
                    </li>
                    <li class="page-scroll">
                        <a href="page/contactenos.html">Contactenos</a>
                    </li>                    
...
<?php
		if(isset($_SESSION['usuario'])){
		  session_destroy();
		  echo "se ha destruido sesión exitosamente <br/>";
   ...
   <div align="center">
                            ...
                            <span class="page-scroll"><a href="page/registrate.html" class="btn-u btn-brd btn-brd-hover btn-u-light">Regístrate</a></span>
    </div>
